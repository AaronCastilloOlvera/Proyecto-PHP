 ...
 <div class="cont1">
  ...
  <div class="form-top">
   ...
   <input class="input" name = "correo"   type="email" placeholder="&#9993; Correo "  
          required>
   <input class="input" name = "numero"   type="number" placeholder="&#888; Numero "  
          required>       
   <input class="input" name = "noTarjeta" type="text" placeholder="&#8962; No Tarjeta" 
          id="visa" >
   <input class="input" name = "cv" type="text" placeholder="&#8962; CV" 
          id="cv">
   
   <!---------------------------->

   <br>   
    <img src="imagenes/img_tarjeta.jpg">  
   <br>
